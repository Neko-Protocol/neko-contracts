...
impl RWATokenContract {
    ...
    pub fn get_price(env: Env) -> Result<crate::neko_oracle::PriceData, Error> {
        Oracle::get_price(&env)
    }

    /// Get the price of this RWA token at a specific timestamp
    pub fn get_price_at(env: Env, timestamp: u64) -> Result<crate::neko_oracle::PriceData, Error> {
    ...
    pub fn get_rwa_metadata(env: Env) -> Result<crate::neko_oracle::RWAMetadata, Error> {
        Oracle::get_rwa_metadata(&env)
    }

    /// Get the asset type of this RWA token
    pub fn get_asset_type(env: Env) -> Result<crate::neko_oracle::RWAAssetType, Error> {
